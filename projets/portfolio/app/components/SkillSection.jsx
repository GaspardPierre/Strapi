...
export default function SkillSection() {
  return (
    <div className="container mx-auto px-4 lg:pt-48">
      <AnimatedElement>
        <h2 className="text-2xl md:text-4xl font-heading mb-8 my-10 text-center hover: cursor-pointer hover:text-white transition-colors duration-400 ease-in">Technical <strong className='text-white'>Skills </strong>in <strong className='text-white'>Web development</strong>by <strong className='text-white'>Pierre Dillard</strong></h2>
      </AnimatedElement>
      <div className="grid grid-cols-1 lg:py-10 md:grid-cols-4 gap-8">
        <AnimatedElement>
          <div>
            <h3 className="text-2xl font-heading mb-4 text-center text-white">Design</h3>
            <p className="font-body text-center text-white py-1 md:py-3"><FontAwesomeIcon icon={faFigma} className="mr-2" />Figma</p>
            <p className="font-body text-center text-white py-1 md:py-3"><FontAwesomeIcon icon={faCss3Alt} className="mr-2" />Tailwind</p>
          </div>
        </AnimatedElement>
        <AnimatedElement>
          <div>
            <h3 className="text-2xl font-heading mb-4 text-white text-center">Front-end</h3>
        ...
        <AnimatedElement>
          <div>
            ...
            <p className="font-body text-center py-1 text-white md:py-3"><FontAwesomeIcon icon={faNodeJs} className="mr-2" />Node.js</p>
            <p className="font-body text-center text-white py-1 md:py-3"><FontAwesomeIcon icon={faDatabase} className="mr-2" />Prisma</p>
            <p className="font-body text-center py-1 text-white md:py-3"><FontAwesomeIcon icon={faDatabase} className="mr-2" />PostgreSQL</p>
            <p className="font-body text-center text-white py-1 md:py-3"><FontAwesomeIcon icon={faDatabase} className="mr-2" />Strapi</p>
          </div>
        </AnimatedElement>
        <AnimatedElement>
          <div>
            <h3 className="text-2xl font-heading mb-4 text-white text-center">Other</h3>
            <p className="font-body text-center text-white py-1 md:py-3"><FontAwesomeIcon icon={faGitAlt} className="mr-2" />Git & GitHub</p>
            <p className="font-body text-center py-1 text-white md:py-3"><FontAwesomeIcon icon={faTasks} className="mr-2" />Trello</p>
